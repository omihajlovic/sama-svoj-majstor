    ...
    <section className="py-24" style={{ backgroundColor: '#ffffff' }}>
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '5rem' }}>
          ...
          {/* Right: services — heading matches left column exactly for alignment */}
          <div>
            <h2
              className="font-cormorant text-[#111111] mb-12"
              style={{ fontWeight: 300, fontSize: '48px', lineHeight: 1.1 }}
            ...
            <div>
              {services.map((service, i) => (
                <Link
                  key={i}
                  href={service.href}
                  className="flex items-center justify-between gap-4 py-8 group transition-opacity duration-300 hover:opacity-50"
                  style={{
                ...
                >
                  <div>
                    ...
                    <p
                      ...
                      style={{ fontWeight: 300, fontSize: '15px', lineHeight: 1.7 }}
                    >
                      {service.description}
                    </p>
                  </div>

                  {/* Arrow: vertically centered, translates 6px right on hover */}
                  <span
                    className="font-outfit text-[20px] text-[#111111] flex-shrink-0 transition-transform duration-300 ease-in-out group-hover:translate-x-1.5"
